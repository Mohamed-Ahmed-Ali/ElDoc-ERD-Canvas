...
const f = (
  name: string,
  type: string,
  pkOrOpts: boolean | Partial<SchemaField> = false,
  description?: string,
): SchemaField => {
  let opts: Partial<SchemaField> = {};
  if (typeof pkOrOpts === "boolean") {
    opts.pk = pkOrOpts;
    opts.role = pkOrOpts ? "pk" : "none";
    opts.keyType = pkOrOpts ? "surrogateSequence" : "attribute";
    if (description) opts.description = description;
  } else {
    opts = { ...pkOrOpts };
    if (description && !opts.description) opts.description = description;
    if (opts.role === "pk" && !opts.keyType) opts.keyType = "surrogateSequence";
  }
  return {
    name,
    type,
    ...
    mart(
      ...
      [
        ...
        f(
          ...
          "STRING",
          false,
          "Recency-Frequency-Monetary segment (e.g. Champions, At-risk).",
        ),
        f(
          "lifetime_orders",
          "INTEGER",
          { isMeasure: true, measureType: "additive" },
          "Total count of orders placed to date.",
        ),
        f(
          "lifetime_gmv",
          "FLOAT",
          { isMeasure: true, measureType: "additive" },
          "Cumulative gross merchandise value across all orders.",
        ),
    ...
    mart(
      ...
      [
        ...
        f(
          ...
          "FLOAT",
          { isMeasure: true, measureType: "additive" },
          "Landed cost — needed for line margin.",
        ),
    ...
    mart(
      ...
      [
        ...
        f(
          ...
          "FLOAT",
          { isMeasure: true, measureType: "additive" },
          "Order value before discounts, shipping and tax.",
        ),
        f(
          "discount_amount",
          "FLOAT",
    ...
    mart(
      ...
      [
        ...
        f(
          ...
          "FLOAT",
          { isMeasure: true, measureType: "additive" },
          "Revenue for the line — unit_price × quantity less discount.",
        ),
        f(
          "line_margin",
          "FLOAT",
          { isMeasure: true, measureType: "additive" },
          "(unit_price − unit_cost) × qty − discount.",
        ),
      ],
    ...
    mart(
      ...
      [
        ...
        f(
          ...
          "INTEGER",
          { isMeasure: true, measureType: "additive" },
          "Count of pages viewed during the session.",
        ),
  ...
  nodes: [
    mart(
      ...
      [
        ...
        f("name", "STRING", { pii: true }, "Company/account name."),
        ...
        f(
          "health_score",
          "INTEGER",
          { isMeasure: true, measureType: "non-additive" },
          "0–100 product-health composite.",
        ),
    ...
    mart(
      ...
      [
        ...
        f("email", "STRING", { pii: true }, "User's email address."),
    ...
    mart(
      ...
      [
        ...
        f(
          ...
          "FLOAT",
          false,
          "Breadth of features touched — activation signal.",
        ),
      ],
  ...
  nodes: [
    ...
    mart(
      ...
      [
        ...
        f("name", "STRING", { pii: true }, "Product display name."),
    ...
    mart(
      ...
      [
        ...
        f("amount", "FLOAT", { isMeasure: true, measureType: "additive" }, "Transaction amount."),
  ...
  nodes: [
    ...
    mart(
      ...
      [
        ...
        f("name", "STRING", { pii: true }, "Payer / insurance plan name."),
  ...
  nodes: [
    mart(
      ...
      [
        ...
        f(
          ...
          "STRING",
          false,
          "Marketing channel the campaign runs on (e.g. paid search, social, email).",
        ),
        f(
          "objective",
          "STRING",
          false,
          "Primary goal of the campaign (e.g. awareness, lead generation).",
        ),
        f(
          "utm_source",
          "STRING",
          false,
          "UTM source tag identifying where the traffic originates.",
        ),
        f(
          "utm_medium",
          "STRING",
          false,
          "UTM medium tag describing the type of traffic (e.g. cpc, email).",
        ),
    ...
    mart(
      ...
      [
        ...
        f(
          ...
          "STRING",
          false,
          "Bucketed size of the lead's company (e.g. 1-50, 51-200).",
        ),
    ...
    mart(
      ...
      [
        ...
        f(
          ...
          "STRING",
          false,
          "Kind of interaction (e.g. ad click, form fill, email open).",
        ),
        f(
          "touch_credit",
          "FLOAT",
          false,
          "Credit assigned to this marketing touch (sums to 1 per lead).",
        ),
    ...
    mart(
      ...
      [
        ...
        f("amount", "FLOAT", { isMeasure: true, measureType: "additive" }, "ACV / deal size."),
    ...
    mart(
      ...
      [
        ...
        f(
          ...
          "INTEGER",
          false,
          "Block version indicating which validation rules to follow.",
        ),
        f(
          "merkle_root",
          "STRING",
        ...
        f(
          ...
          "STRING",
          false,
          "Value miners vary to satisfy the proof-of-work difficulty target.",
        ),
    ...
    mart(
      ...
      [
        f(
          ...
          "STRING",
          true,
          "Transaction hash (txid) that uniquely identifies the transaction.",
        ),
        ...
        f(
          ...
          "INTEGER",
          false,
          "Virtual transaction size in virtual bytes (SegWit-weighted).",
        ),
        ...
        f(
          ...
          "INTEGER",
          false,
          "Earliest block height or time at which the transaction may be added.",
        ),
    ...
    mart(
      ...
      [
        ...
        f(
          ...
          "INTEGER",
          false,
          "Output index in the prior transaction being spent.",
        ),
        f(
          "script_asm",
          "STRING",
          false,
          "Unlocking script (scriptSig) in human-readable assembly.",
        ),
    ...
    mart(
      ...
      [
        ...
        f(
          ...
          "STRING",
          false,
          "Locking script (scriptPubKey) in human-readable assembly.",
        ),
  ...
  nodes: [
    ...
    mart(
      ...
      [
        ...
        f("name", "STRING", { pii: true }, "Name of the badge."),
...
export const TEMPLATES: Template[] = [
  {
    ...
    description:
      "Sales star schema: order & line-item margin, web sessions and returns over conformed customer/product dimensions.",
    graph: ecommerce,
  },
  {
    id: "saas",
    ...
    description:
      "Recurring revenue: accounts, seats, MRR-movement events, invoices, daily product usage and support.",
    graph: saas,
  },
  {
    id: "marketplace",
    name: "Marketplace",
    description:
      "Two-sided platform: buyers, sellers, listings, search demand, GMV/take-rate orders and reviews.",
    graph: marketplace,
  },
  {
    id: "marketing_ads",
    ...
    description:
      "B2B funnel: cross-channel ad spend, campaigns, marketing touchpoints, leads and pipeline opportunities.",
    graph: marketing_ads,
  },
  {
    id: "mobile_gaming",
    name: "Mobile / Gaming",
    description:
      "Free-to-play telemetry: players, sessions, events, IAP, ad impressions and user-acquisition spend.",
    graph: mobile_gaming,
  },
  {
    id: "finance",
    ...
    description:
      "Neobank & lending: customers (KYC/risk), accounts, transactions, loan origination and repayments.",
    graph: finance,
  },
  {
    id: "medical",
    name: "Healthcare",
    description:
      "Provider analytics: patients, providers, appointments, encounters (LOS/readmission) and claims/denials.",
    graph: medical,
  },
  {
    id: "crypto_bitcoin",
    name: "Bitcoin (crypto)",
    description:
      "Blocks, transactions, inputs and outputs from the public Bitcoin BigQuery dataset.",
    graph: crypto_bitcoin,
  },
  {
    id: "stackoverflow",
    name: "Stack Overflow",
    description:
      "Users, questions, answers, comments, votes, badges and tags from the public Stack Overflow BigQuery dataset.",
    graph: stackoverflow,
  },
  {
    id: "feature_showcase",
    name: "Enterprise Data Platform (Feature Showcase)",
    description:
      "A massive demonstration model showcasing all ERD features: groups, relationship types, node coloring, domains/namespaces, KPIs, glossary, comments, and advanced physical/logical data types across 15+ tables.",
    graph: {
      storageId: null,
      glossary: [
        {
      ...
      kpis: [
        ...
        },
        {
          ...
          definition: "Average time taken to resolve a support ticket.",
