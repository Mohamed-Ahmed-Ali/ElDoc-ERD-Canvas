    ...
    >
      <defs>
        ...
        <pattern id="canvas-grid" width="48" height="48" patternUnits="userSpaceOnUse">
          <circle cx="24" cy="24" r="1" fill="#50331c" opacity="0.12" />
        </pattern>
      ...
      <g clipPath="url(#app-icon-clip)">
        ...
        <g opacity="0.15">
          <path
            d="M 40 100 L 120 100 M 100 40 L 100 120"
            stroke="#50331c"
            strokeWidth="2"
            strokeDasharray="4 4"
          />
          <path
            d="M 400 420 L 480 420 M 420 380 L 420 460"
            stroke="#50331c"
            strokeWidth="2"
            strokeDasharray="4 4"
          />
        ...
        <g>
          ...
          <line x1="180" y1="320" x2="332" y2="320" stroke="#d76f32" strokeWidth="4" />
