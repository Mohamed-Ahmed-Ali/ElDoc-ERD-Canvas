...
export type Tool = "select" | "add" | "group" | "connect" | "layout";
...
const GroupIcon = () => (
  ...
  >
    ...
    <path d="M9 9h6v6H9z" fill="currentColor" stroke="none" opacity={0.2} />
  </svg>
);
  ...
  return (
    ...
    >
      ...
      <div className="relative group">
        ...
        <DockTip
          label={
            clearDisabled ? "Clear canvas — nothing to clear" : "Clear canvas — delete everything"
          }
        />
      </div>
    </div>
