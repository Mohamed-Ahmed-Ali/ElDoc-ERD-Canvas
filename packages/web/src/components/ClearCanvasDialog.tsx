    ...
    >
      <div className="bg-white rounded-xl shadow-xl w-[460px] max-w-[95vw] p-6 flex flex-col gap-4">
          ...
          {!empty && (
            <>
              ...
              <span className="font-semibold">
                {counts.marts} {counts.marts === 1 ? "mart" : "marts"}
              </span>{" "}
              and{" "}
              <span className="font-semibold">
        ...
        <p className="text-[13px] text-slate-600">
          We recommend exporting an <span className="font-semibold">OKF</span> bundle to your
          computer first so you can re-import this model later.
        </p>
