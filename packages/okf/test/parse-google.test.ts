  ...
  it("resolves a strict ## Joins link given a nested relative path", () => {
    const files = {
      "orders.md": [
        ...
        "## Joins",
        "",
        "- [Customers](./sub/dir/customers.md) — `customer_id = id`",
        "",
      ].join("\n"),
      "customers.md": [
        "---",
...
describe("Google OKF v0.1 — prose joins", () => {
  ...
  it("recovers Bitcoin inputs→transactions with a key and inputs→outputs keyless", () => {
    ...
    expect(
      t!.keys.some((k) => k.left === "transaction_hash" || k.right === "transaction_hash"),
    ).toBe(true);
...
describe("prose pass never fires on ElDoc-format docs", () => {
  it("ignores a relative .md link in an ElDoc mart description", () => {
    const files = {
      "orders.md": [
        "---",
        'type: "ElDoc Data Mart"',
        ...
        "# Orders",
        "",
        "This table can be joined with the [Customers](./customers.md) table.",
        "",
        "## Schema",
        "",
        "| Column | Type | Description |",
